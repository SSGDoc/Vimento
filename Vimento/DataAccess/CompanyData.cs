...
namespace Vimento.DataAccess
{
    public class CompanyData
    {
        ...
        public CompanyData()
        {
            //Insert password to database after "pwd="
